...
static Scanner sc = new Scanner(System.in);
   ...
   static ArrayList<ArrayList<?>> position2Array = new ArrayList<>();
...
//   }
   ...
   private static void formatArry() {
 	  //positionArray <-> position2Array
 	  //1) positionArray 배열의 값을 꺼낸다 > 바로 2중 배열에 저장
 	  ...
 	  for(int i=0; i<position2Array.size(); i++) {
 		 ...
 		 System.out.println(position2Array.get(i).get(0) +" "+ 
 				 			position2Array.get(i).get(1) +" "+ 
 				 			position2Array.get(i).get(2) +" --"+
 				 			position2Array.get(4)+"--");
// 		  System.out.println(position2Array.get(i).get(0));
// 		  System.out.println(position2Array.get(i).get(1));
// 		 System.out.println(position2Array.get(i).get(2));
 	  }
   }
