package com.human.code20220929;

import java.util.ArrayList;
import java.util.Date;
import java.util.Scanner;

public class java05_0009_studentRandomPosition_4 {
...
//      }
 ...
 private static void input() {
	   ...
	   System.out.println("학생을 추가하겠습니까?");
	   System.out.println("1. 예   2. 아니요");
		   for(int i = 0; i<positionArray.size(); i++) {
			   ...
			   if(inpu==1) {
				   ...
				   String inputstudent = scan.nextLine();
				   System.out.println("원하는 자리를 고르세요");
				   int wp = scan.nextInt();
				   positionArray.add(wp ,inputstudent);
				   System.out.println(inputstudent + "학생을 "+ wp + "번 자리에 추가했습니다.");
				   System.out.println("학생을 더 추가하겠습니까?");
				   System.out.println("1. 예   2. 아니요");
...
//				   System.out.println("추가할 사람의 이름을 입력하세요");
//				   String inputstudent = scan.nextLine();
//				   positionArray.add(inputstudent);
//				   System.out.println(inputstudent + "을 추가했습니다.");
//				   System.out.println("학생을 더 추가하겠습니까?");
//				   System.out.println("1. 예   2. 아니요");
//				   
//			   }else if(inpu==2) {  
